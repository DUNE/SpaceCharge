    ...
    if(axis == "X")
        {
            ...
            offsetValNew = 100.0 * initialEFieldFitFunctionX->Eval(bValNew);
        }
    else if(axis == "Y")
        {
            for(int i = 0; i < initialEFieldFitPolN[1] + 1; i++)
            ...
            offsetValNew = 100.0 * initialEFieldFitFunctionY->Eval(bValNew);
        }
    else if(axis == "Z")
        {
            for(int i = 0; i < initialEFieldFitPolN[2] + 1; i++)
            ...
            offsetValNew = 100.0 * initialEFieldFitFunctionZ->Eval(bValNew);
        }
