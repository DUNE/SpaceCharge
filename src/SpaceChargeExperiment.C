////////////////////////////////////////////////////////////////////////
// \file SpaceChargeExperiment.C
// \brief implementation of class for storing/accessing space charge distortions for Experiment
////////////////////////////////////////////////////////////////////////
...
// LArSoft includes
#include "SpaceChargeExperiment.h"


//-----------------------------------------------
SpaceChargeExperiment::SpaceChargeExperiment()
{
    Configure("SCEoffsets_Experiment_DriftField.root");
}

//-----------------------------------------------
SpaceChargeExperiment::SpaceChargeExperiment(std::string filename)
{
    Configure(filename);
}
...
//------------------------------------------------
bool SpaceChargeExperiment::Configure(std::string filename)
{
...
std::vector<double> SpaceChargeExperiment::GetPosOffsets(double xVal, double yVal, double zVal) const
{
...
std::vector<double> SpaceChargeExperiment::GetPosOffsetsParametric(double xVal, double yVal, double zVal) const
{
...
/// axis
double SpaceChargeExperiment::GetOnePosOffsetParametric(double xValNew, double yValNew, double zValNew, std::string axis) const
{
    double parA[6][7];
    double parB[6];
...
std::vector<double> SpaceChargeExperiment::GetEfieldOffsets(double xVal, double yVal, double zVal) const
{
...
std::vector<double> SpaceChargeExperiment::GetEfieldOffsetsParametric(double xVal, double yVal, double zVal) const
{
...
/// axis
double SpaceChargeExperiment::GetOneEfieldOffsetParametric(double xValNew, double yValNew, double zValNew, std::string axis) const
{
    double parA[6][7];
    double parB[6];
...
double SpaceChargeExperiment::TransformX(double xVal) const
{
    double xValNew;
...
double SpaceChargeExperiment::TransformY(double yVal) const
{
    double yValNew;
...
double SpaceChargeExperiment::TransformZ(double zVal) const
{
    double zValNew;
...
bool SpaceChargeExperiment::IsInsideBoundaries(double xVal, double yVal, double zVal) const
{
    bool isInside = true;
