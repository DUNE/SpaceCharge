////////////////////////////////////////////////////////////////////////
// \file SpaceChargeExperiment.h
// \brief header of class for storing/accessing space charge distortions for Experiment/
////////////////////////////////////////////////////////////////////////
...
class SpaceChargeExperiment
{

 public:

    SpaceChargeExperiment();
    SpaceChargeExperiment(std::string filename);
    ~SpaceChargeExperiment();
