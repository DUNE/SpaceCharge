...
#include "../TestFiles/SpaceChargeProtoDUNE.h"
...
int main()
{
    ...
    /**
       ...
       SpaceChargeMicroBooNE *oldExperiment = new SpaceChargeMicroBooNE("../TestFiles/Mike_SCEoffsets_MicroBooNE_E500.root");
       TFile *FileInput = new TFile("../InputFiles/dispOutput_MicroBooNE_E500.root");
       TFile *histoFile = new TFile("MicroBooNEOffsetsComparision.root", "RECREATE");
       int xMin = 0;
       int xMax = 260;
       int yMin = -120;
       int yMax = 120;
